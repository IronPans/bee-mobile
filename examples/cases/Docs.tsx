            ...
            <div className="Main height-100">
                ...
                <View reveal={this.state.reveal} onClose={this.toggleSidebar}>
                    <Page className="ApiPage">
                        <NavBar
                            fixed={true}
                            left={<Button shape="circle" onClick={this.openSidebar}>
                        ...
                        >
                            {API_ROUTING.map((route: any, i: number) => (
                                <Route
                                    ...
                                    render={(props: any) => (
                                        <route.component
                                            {...getOtherProperties(props, ['staticContext'])}
                                            routes={route.routes}
                                        />
                                    )}
                                />
                    ...
                    <div className="padding-10">
                        ...
                        <p>我们使用
                            <a href="https://github.com/IronPans/bee-mobile/issues" target="_blank">
                                GitHub Issues</a>来做
                            bug 追踪。</p>
                        <p>在你报告一个 bug 之前，请先确保已经搜索过已有的 issue 和阅读了我们的<a
                            href="https://github.com/IronPans/bee-mobile/wiki/FAQ"
                            target="_blank"
                        >
                            常见问题
                        </a>。</p>
