...
import AlertCase from './cases/AlertCase';
import AlertApi from './Api/AlertApi';
import DropdownCase from './cases/DropdownCase';
import DropdownApi from './Api/DropdownApi';

export const ROUTE_CONFIG: any = [
    { path: '/components/alert', component: AlertCase },
    ...
    { path: '/components/dropdown', component: DropdownCase },
...
export const API_ROUTING = [
    ...
    { path: '/docs/alert', component: AlertApi },
    ...
    { path: '/docs/dropdown', component: DropdownApi },
