...
export default class Calendar extends React.PureComponent<CalendarProps, CalendarState> {
    ...
    createCalendar() {
        ...
        let {currentYear, currentMonth, currentDay}: any = this.state;
        let calendar: any = [];
        if (currentMonth >= 13) {
            currentMonth = 1;
            currentYear += 1;
            ...
            return (<tr key={'row_' + i}>
                {
                    w.map((day: any, j: number) => {
                        ...
                        return (<td key={'col_' + j} className={styleClass}
    ...
    selectDate(value: any, event: any) {
        ...
        this.setState({
            ...
            if (this.props.onChange && event) {
                (this.props.onChange as Function)(selectedValue);
            }
        });
    }
                            ...
                            <div className="Calendar-wrapper">
                                <div className="Calendar-header">
                                    <div className="Calendar-select">
                                        <div className="Calendar-select-prev" onClick={this.toChangeDate.bind(this, -1, false)}>
                                            <i className="icon icon-prev"/>
                                        </div>
                                        <div className="Calendar-month">
                                            {this._selectLocale.monthNamesShort[currentMonth! - 1]}
                                        </div>
                                        <div className="Calendar-select-next" onClick={this.toChangeDate.bind(this, 1, false)}>
                                            <i className="icon icon-next"/>
                                        </div>
                                    </div>
                                    <div className="Calendar-select">
                                        <div className="Calendar-select-prev"
                                             onClick={this.toChangeDate.bind(this, -1, true)}>
                                            <i className="icon icon-prev"/>
                                        </div>
                                        <div className="Calendar-year">{currentYear}</div>
                                        <div className="Calendar-select-next"
                                             onClick={this.toChangeDate.bind(this, 1, true)}>
                                            <i className="icon icon-next"/>
                                        </div>
                                    </div>
                                ...
                                <div className="Calendar-body">
                                    <table>
                                        <thead><tr>{this.createWeek()}</tr></thead>
