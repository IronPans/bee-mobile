    ...
    render() {
        ...
        return (
            <div className={styleClass} onMouseLeave={this.handleMouseLeave}>
                <div className={`${prefixCls}-header`} onMouseOver={this.handleMouseover}
                     onClick={this.toggle}>{children}</div>
                    ...
                    <ul>
                        {
                            data.map((item, index) => {
                                if (item.divider) {
                                    return (
                                        <li key={index} className={`${prefixCls}-divider`}></li>
                                    )
                                }
                                return (
                                    <li key={index} className={`${prefixCls}-menu-item`}
